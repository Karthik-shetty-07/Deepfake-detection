...
class VideoProcessor:
    ...
    def _init_face_detector(self):
        ...
        logger.info("Using face detector: %s", self.detector_type)
    ...
    def process_video(self, video_path: str) -> List[FaceData]:
        ...
        logger.info(
            "Processing video: %d frames, %.1fs duration",
        ...
        logger.info("Extracted %d faces from video", len(all_faces))
...
def validate_video_file(file_path: str, max_size_mb: float = None) -> Tuple[bool, str]:
    """
